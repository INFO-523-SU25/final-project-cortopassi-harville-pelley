...
people['full_name'] = people['nameFirst'] + " " + people['nameLast']

# Build dropdown options
player_names = sorted(people['full_name'].dropna().unique())

def show_player(player):
    print(f"You selected: {player}")

interact(show_player, player=Dropdown(options=player_names, description="Player:"))
